...
public class AdminServices {
    ...
    public List<UserBean> getAllMales() {
    ...
    public List<UserBean> getAllFemales() {
    ...
    public List<BookBean> getAvailableBooks() {
    ...
    public Map<String, List<OrderBean>> getAllOrders() {
...
//        });
    ...
    public void addOffer(int offerPercent, String offerDate) throws ParseException {
