...
public class WishListServices {
    ...
    public List<BookBean> getUserWishList(int userID) {
    ...
    public void addToUserWishList(int userID, int bookID) {
    ...
    public boolean isBookInUserWishList(int userID, int bookID) {
        Book book = bookDao.getBookByID(bookID);
        boolean bookIsExist = false;
        List<Book> bookList = bookDao.getUserWishList(userID);
        Set<Book> bookSet = new HashSet<>(bookList);
