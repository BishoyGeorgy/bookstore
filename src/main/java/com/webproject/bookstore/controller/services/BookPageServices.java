...
public class BookPageServices {
     ...
     * @param bookId
     */
    public void updateBookVisits(int bookId) {
    ...
    public void updateBookRate(int bookId, int rate, int userId) {
        Book book = bookDao.getBookByID(bookId);
    ...
    public List<BookBean> getRelatedBooks(int bookId) {
        Book book = bookDao.getBookByID(bookId);
        List<Book> relatedCategory = bookDao.getAllBooksInCategory(book.getCategory().getCategoryName(), 10);
