...
public class UserCartServices {
    ...
    public List<CartBean> getUserCart(int userId) {
    ...
    public List<CartBean> getUserCart(User user) {
    ...
    public void removeCartItem(CartBean cartBean) throws ParseException {
    ...
    public void addToCart(int userId, int bookId, int reqQuantity) {
        boolean added = false;
    ...
    public boolean checkOut(List<CartBean> cartBeanList,int userId) {
