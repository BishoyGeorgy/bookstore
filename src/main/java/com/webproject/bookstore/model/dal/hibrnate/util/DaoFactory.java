...
public class DaoFactory{
    ...
    public static CategoryDao getCategoryDao() throws UnsupportedOperationException{
        Session session = SessionManager.getSession();
        return new CategoryDao(session);
    }
    
    public static BookDao getBookDao() throws UnsupportedOperationException{
        Session session = SessionManager.getSession();
        return new BookDao(session);
    }
    
    public static BookOrderDao getBookOrderDao() throws UnsupportedOperationException{
        Session session = SessionManager.getSession();
        return new BookOrderDao(session);
    }
    
    public static OfferDao getOfferDao() throws UnsupportedOperationException{
        Session session = SessionManager.getSession();
        return new OfferDao(session);
    }
    
    public static UserDao getUserDao() throws UnsupportedOperationException{
        Session session = SessionManager.getSession();
        return new UserDao(session);
    }
    
    public static UserCartBookDao getCartBookDao() throws UnsupportedOperationException{
        Session session = SessionManager.getSession();
        return new UserCartBookDao(session);
    }
    
    public static UserOrderDao getOrderDao() throws UnsupportedOperationException{
        Session session = SessionManager.getSession();
        return new UserOrderDao(session);
    }
    
    public static UserVisitBookDao getUserVisitBookDao() throws UnsupportedOperationException{
        Session session = SessionManager.getSession();
