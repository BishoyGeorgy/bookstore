...
public class DataBaseIntializer {
    ...
    public void insertListOfBooks(List<Book> bookList) {
        bookList.forEach((book) -> {
            Book book1 = bookDao.insert(book);
        });
    }

    public void fillBooks() throws IOException, InvalidFormatException {
    ...
    public void fillOffers() throws ParseException {
